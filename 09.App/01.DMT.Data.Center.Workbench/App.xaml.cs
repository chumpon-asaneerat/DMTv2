        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            EnvironmentOptions option = new EnvironmentOptions()
            {
                ...
                AppInfo = new NAppInformation()
                {
                    ...
                    CompanyName = "DMT",
                    /*  This property is required */
                    ProductName = AppConsts.Application.DataCenter.ApplicationName,
                    /* For Application Version */
                    Version = AppConsts.Application.DataCenter.Version,
                    Minor = AppConsts.Application.DataCenter.Minor,
                    Build = AppConsts.Application.DataCenter.Build,
                    LastUpdate = AppConsts.Application.DataCenter.LastUpdate
                },
                /* Setup Storage */
