...
{
    /// <summary>
    /// Interaction logic for RevenueSupervisorSelectionPage.xaml
    /// </summary>
    public partial class RevenueSupervisorSelectionPage : UserControl
    {
        #region Constructor
        ...
        /// Constructor.
        /// </summary>
        public RevenueSupervisorSelectionPage()
        {
            InitializeComponent();
        }
        ...
        {
            // Revenue Entry Page
            var page = new RevenueSupervisorPage();
        ...
        public void Setup(User user ,DateTime dt)
        {
            LoadPlazaGroups();
            dtDate.SelectedDate = dt;
